...
class Clases:
    ...
    def tresvalores(self):
        ...
        if num == 1:
            p = 100 * con
            print(
                "La accion:{},el valor constante se multiple con el segun valor ingresado :{}".format(
                    num, p))
        elif num == 2:
            p = 100 ** num
            print(
                "La accion:{},el valor constante se eleve con el segun valor ingresado :{}".format(
                    num, p))
        elif num == 3:
            p = 100 / num
            print(
                "La accion:{},el valor constante se divida con el segun valor ingresado :{}".format(
                    num, p))
        else:
            p = 0
